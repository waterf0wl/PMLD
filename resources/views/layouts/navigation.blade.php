        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    ...
                    <img src="assets/logo.png" alt="SYPENTEST logo" class="h-9" />
                    </a>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->roles == 'administrator')
                        <x-nav-link :href="route('attacker')" :active="request()->routeIs('attacker')">
                            {{ __('Attacker') }}
                        </x-nav-link>
                        <x-nav-link :href="route('defender')" :active="request()->routeIs('defender')">
                            {{ __('Defender') }}
                        </x-nav-link>
