  ...
  <body class="bg-gray-100 text-gray-800">
    ...
    <section class="relative h-screen flex items-center justify-center">
      ...
      <div class="relative z-10 text-center text-white p-6 bg-black bg-opacity-50 rounded-lg">
        <h2 class="text-4xl font-bold mb-4">
          <span class="text-yellow-400">SYPENTEST-TRI</span>
        </h2>
        <p class="text-lg mb-6">
          System Penetration Testing Teknologi Rekayasa Internet
        </p>
        <div class="flex justify-center space-x-4">
          ...
          <a
            href="#about-section"
            class="bg-transparent border border-yellow-400 text-yellow-400 px-4 py-2 rounded hover:bg-yellow-500 hover:text-black transition"
            >About Us</a
          >
        </div>
      </div>
    ...
    <section id="about-section" class="py-16 bg-gray-50">
      ...
      <div class="max-w-3xl mx-auto text-center text-lg space-y-4">
        <p>
          Discover the state-of-the-art in cybersecurity with SYPENTEST, an
          extensive system penetration testing tool created by Universitas
          Gadjah Mada's Internet Engineering Technology Program.
        </p>
        <p>
          SYPENTEST offers an environment and tools for practicing,
          experimenting, and improving your abilities in network security,
          vulnerability testing, and cyber defense strategies.
        </p>
      </div>
      <div class="relative mt-12">
        <img
          src="assets/aset2.png"
          alt="Aset Top Right"
          class="absolute top-0 right-0 w-32 opacity-75"
        />
        <img
          src="assets/aset3.png"
          alt="Aset Bottom Left"
          class="absolute bottom-0 left-0 w-32 opacity-75"
        />
      </div>
    </section>
      ...
      <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="flex flex-col items-center">
            ...
            <p class="text-center">
              We ensure that all aspects of your system work together to create
          ...
          <div class="flex flex-col items-center">
            ...
            <p class="text-center">
              We are dedicated to providing top-quality system security
              solutions.
            </p>
          </div>
      ...
      <div class="max-w-6xl mx-auto flex justify-between items-start space-y-4 flex-wrap">
        ...
        <ul class="space-y-2">
          <li class="flex items-center space-x-2">
            ...
            <a href="mailto:sypentest@gmail.com" class="hover:underline">sypentesttri@gmail.com</a>
          </li>
          <li class="flex items-center space-x-2">
