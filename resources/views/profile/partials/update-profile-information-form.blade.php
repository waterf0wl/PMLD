<main class="max-w-3xl mx-auto mt-10 p-12 space-y-16">
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2 text-black">
                        ...
                        <button form="send-verification" class="underline text-sm text-black hover:text-black-700 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
